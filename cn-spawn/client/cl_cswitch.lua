...
Citizen.CreateThread(function()
	exports["cn-polyzone"]:AddBoxZone("spawnZone", vector3(-3962.55, 2014.91, 500.91), 31.2, 20.2,  {
		name="spawn",
        heading=340,
        minZ=498.51,
        maxZ=506.31
...
AddEventHandler("cn-polyzone:enter", function(name)
    if name ~= "spawnZone" then return end
    checkPlayers()
end)
AddEventHandler("cn-polyzone:exit", function(name)
    if name ~= "spawnZone" then return end
    listening = false
end)